...
<head>
  ...
  <title>CvSU Syllabus | Syllabus Storage </title>
      ...
      <section class="main">
        ...
        <div class="users">
          <div class="card">
            <br></br>
            <br>
            <a href="dn-files-com.php">
              <center><i class="fa fa-file fa-5x" style="color:#25963A" ;></i>
                <br></br>
                <?php
                include('../config.php');
