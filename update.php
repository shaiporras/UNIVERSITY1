...
// -----------------------------------------------------------------------------
    ...
    // --------------------------------- Course ------------------------------------
    $course = '[' . $code . ']' .  ', [' . $title . ']' . ', [' . $type . ']' . ', [' . $units . ']' . ', [' . $desc . ']' . ', [' . $prereq . ']' . ', [' . $sched . ']';
    // --------------------------------- Weeks ------------------------------------
    ...
    $sql = "UPDATE `syllabus` SET `course_code`=\"". $code ."\",`course_title`=\"" .$title."\",`course_type`=\"". $type . "\",`course_units`=\"" .$units. "\",`course_pre-req`=\"" .$prereq. "\",`course_shced`=\"" .$sched. "\",`course_description`=\"" .$desc."\",`check_a`=\"" . $check_a . "\",`check_b`=\"" . $check_b . "\",`check_c`=\"" . $check_c . "\",`check_d`=\"" . $check_d . "\",`check_e`=\"" . $check_e . "\",`check_f`=\"" . $check_f . "\",`check_g`=\"" . $check_g . "\",`check_h`=\"" . $check_h . "\",`check_i`=\"" . $check_i . "\",`check_j`=\"" . $check_j . "\",`level_a`=\"" . $level_a . "\",`level_b`=\"" . $level_b . "\",`level_c`=\"" . $level_c . "\",`level_d`=\"" . $level_d . "\",`level_e`=\"" . $level_e . "\",`level_f`=\"" . $level_f . "\",`week_a`=\"" . $week_a . "\",`week_b`=\"" . $week_b . "\",`week_c`=\"" . $week_c . "\",`week_d`=\"" . $week_d . "\",`week_e`=\"" . $week_e . "\",`week_f`=\"" . $week_f . "\",`week_g`=\"" . $week_g . "\",`course_req`=\"" . $course_req . "\",`grading_system`=\"" . $grading_system . "\",`class_policies`=\"" . $course_policies. "\",`ref_sup`=\"" . $rep_sup . "\",`rev`=\"" . $rev . "\",`instructor`=\"" . $instructor . "\",`chairperson`=\"" . $chairperson . "\" WHERE `id` = $id";
    

    $con->query($sql);

    echo("<script>alert('Form successful Updated!')</script>");
