...
<html lang="en">
  <head>
    ...
    <title>CvSU Syllabus | Admin</title>
                ...
                while($row = $result->fetch_assoc()){
                  ...
                  ?>
                    ...
                    <tr> 
                            ...
                            <td>
                            <a class='btn btn-danger' href='dept-masscom.php?id=<?php echo $row['id']; ?>' title='Delete Record' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'>Remove</span></a>
                            </td>
