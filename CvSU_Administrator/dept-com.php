...
?>
    <div class="sidebar">
      ...
      <li>
        ...
        <li>
          <a href="ChairpersonSyllabus.php">
            <i  class="fa fa-file"></i>
            <span class="links_name">View Syllabus</span>
          </a>
        </li>

        <li>
          <a href="ChairpersonSubmit.php">
            <i class="fa fa-paper-plane"></i>
            <span class="links_name">Send Syllabus</S></span>
          </a>
        </li>

        <li>
          <a href="ChairpersonAssign.php">
            <i class="fa fa-paper-plane"></i>
            <span class="links_name">Assign Syllabus</S></span>
          </a>
        </li>
    ...
    <section class="home-section">
      ...
      <table class="table table-hover text-center">
            <thead class="table-success mb-3">
              <br></br>
                <h3><b>Department of Computer Studies</b></h3>
                <br>
                <br>
                <tr>
                    <th>ID</th>
