            ...
            <div class="card">
              <div class="container">
                ...
                <div class="row">
                  ...
                  <form id="pdfform" name="Form1" action="../pdf.php?id=<?php echo $loggedin_id ?>" method="POST" style="width: 70vw; min-width: 300px;">
                  <?php } ?>
                  <div class="row">
                ...
                <div style="color:green;text-align:right;">
                  <td colspan="2" align-="right"><input type="submit" onclick="Form1.action='../insert.php?id=<?php echo $loggedin_id ?>'" id="button" name="submit" class="btn btn-success" value="Save Syllabus"></td>
