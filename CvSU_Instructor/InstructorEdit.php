                  ...
                  <form action="AdminAdd.php" method="post" style="width: 70vw; min-width: 300px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col">
                        ...
                        <input type="text" class="form-control" name="ins_no" placeholder="#" required </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                        ...
                        <div class="col mb-4">
                          ...
                          <input type="text" class="form-control" name="pass" placeholder="Enter Password"
                            pattern=".{8,16}" title="8 or more Character" size=30 pattern="[!@#$%^&*][a-z][A-Z][0-9]"
                            required>
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <select class="form-select" name="ins_sched1" aria-label="Default select example" disabled>
                        ...
                        <div class="col">
                          ...
                          <select class="form-select" name="ins_sched2" aria-label="Default select example" disabled>
                            <option value="Mon 6:00 -7:00 pm"> Mon 6:00 -7:00 pm</option>
                            <option value="Tue 6:00 -7:00 pm">Tue 6:00 -7:00 pm</option>
                          </select>
                        </div>
